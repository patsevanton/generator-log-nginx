...
| IPV4_PERCENT          | Нет          | 100          | Процент IPv4-адресов (в текущей версии не используется)                  |
| STATUS_OK_PERCENT     | Нет          | 80           | Процент успешных статусов (в текущей версии не используется)             |
...
- Переменные с процентами из оригинальной версии (`IPV4_PERCENT`, `STATUS_OK_PERCENT`) остаются для обратной совместимости, но не влияют на генерацию
